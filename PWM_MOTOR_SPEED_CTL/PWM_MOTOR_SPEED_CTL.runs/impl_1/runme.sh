...
HD_PWD='/home/rehan/MERL/FPGA_EMU/PWM_MOTOR_SPEED_CTL/PWM_MOTOR_SPEED_CTL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PWM_controller.tcl -notrace
