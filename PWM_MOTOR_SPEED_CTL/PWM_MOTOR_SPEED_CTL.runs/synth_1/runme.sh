...
HD_PWD='/home/rehan/MERL/FPGA_EMU/PWM_MOTOR_SPEED_CTL/PWM_MOTOR_SPEED_CTL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PWM_controller.tcl
