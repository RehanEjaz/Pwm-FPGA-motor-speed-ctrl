...
#set_property -dict { PACKAGE_PIN F6    IOSTANDARD LVCMOS33 } [get_ports { PWM_O }]; #IO_L19N_T3_VREF_35 Sch=led0_g
...
## Pmod Header JA
#set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { PWM_O }]; #IO_0_15 Sch=ja[1]
